...
class Game():
    ...
    def winScreen(self):
        ...
        yRect = you.get_rect()
        yRect.center = (150, 165)
        wRect = win.get_rect()
        wRect.center = (150, 215)
        self.gameDisplay.blit(you, yRect)
        self.gameDisplay.blit(win, wRect)
        pygame.display.update()
    ...
    def loseScreen(self):
        ...
        font = pygame.font.Font('freesansbold.ttf', 50)
        you = font.render('YOU', True, (225, 225, 225))
        lose = font.render('LOSE', True, (225, 225, 225))
        yRect = you.get_rect()
        yRect.center = (150, 165)
        lRect = lose.get_rect()
        lRect.center = (150, 215)
        self.gameDisplay.blit(you, yRect)
        self.gameDisplay.blit(lose, lRect)
        pygame.display.update()
        pygame.time.delay(10000)
    ...
    def instructionScreen(self):
        ...
        while (not Done):
            ...
            wRect.center = (150, 90)
            aRect = a.get_rect()
            aRect.center = (150, 135)
            sRect = s.get_rect()
            sRect.center = (150, 180)
            dRect = d.get_rect()
            dRect.center = (150, 225)
            spaceRect = space.get_rect()
            spaceRect.center = (150, 270)
            shRect = shSpace.get_rect()
            shRect.center = (150, 315)
            bRect = back.get_rect()
            bRect.center = (30, 15)
